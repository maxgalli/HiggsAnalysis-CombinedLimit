...
LIBS = $(ROOTLIBS) -lgsl -lRooFit -lRooFitCore -lRooStats -lRooFitHS3 -lMinuit -lMathMore -lFoam -lHistFactory -lboost_filesystem -lboost_program_options -lboost_system -lvdt
